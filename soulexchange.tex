...
\usepackage{geometry}
%\usepackage[a5paper,landscape,twoside]{geometry}

%\geometry{a4paper,layoutwidth=210mm,layoutheight=148mm,layouthoffset=1.81cm,layoutvoffset=3.1cm,twoside,showcrop,landscape}
...
text depth=15mm,text width=\pagenumwidth}}
...
\titleformat{\chapter}{\gdef\chapterlabel{}\Huge\bfseries}{\gdef\chapterlabel{}}{0pt}
  ...
  \node[anchor=west,text width=\textwidth,align=right,xshift=-5pt,yshift=-150pt] at (0,0) {\chapterlabel#1};
...
%\newfontfamily{\T}{Champagne & Limousines}
\newfontfamily{\T}{Diavlo Light Regular}
